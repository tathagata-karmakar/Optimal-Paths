...
fig, axs = plt.subplots(4,2,figsize=(12,12),sharex='all')
q1i = expect(X,rho_i)
q1f = expect(X,rho_f)
q2i = expect(P,rho_i)
q2f = expect(P,rho_f)
...
axs[0,0].set_ylabel(r'$\left\langle\hat{X}\right\rangle$',fontsize=18)
...
axs[1,0].set_ylabel(r'$\left\langle\hat{P}\right\rangle$',fontsize=18)
...
axs[2,0].set_ylabel(r'$\textrm{var}\hat{X}$',fontsize=18)
...
axs[0,1].set_ylabel(r'$\textrm{var}\hat{P}$',fontsize=18)
...
axs[1,1].set_ylabel(r'$r^\star$',fontsize=18)
axs[1,1].tick_params(labelsize=15)

axs[2,1].plot(ts, theta_t,linewidth =5, color='g', linestyle='--')
axs[2,1].set_ylabel(r'$\theta^\star$',fontsize=18)
axs[2,1].tick_params(labelsize=15)

axs[3,1].plot(ts, l1_t, linewidth =5, color='g', linestyle='--')
axs[3,1].set_ylabel(r'$\lambda_1^\star$',fontsize=18)
axs[3,1].tick_params(labelsize=15)

plt.subplots_adjust(wspace=0.25, hspace=0.1)
#plt.savefig('/Users/tatha_k/Library/CloudStorage/Box-Box/Research/Optimal_Path/Codes/Optimal-Paths/Plots/Ex4_Optimal_control.pdf',bbox_inches='tight')
