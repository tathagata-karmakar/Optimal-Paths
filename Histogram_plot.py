...
hf = h5py.File('/Users/tatha_k/Library/CloudStorage/Box-Box/Research/Optimal_Path/Codes/Optimal-Paths/Data/Histogram_Ex4.hdf5', 'r')
...
ax.hist(fidelities_OP, label = 'w Optimal Control', hatch ='|')
ax.hist(fidelities0, label="wo control", alpha = 0.6, hatch ='\\')
...
#ax.set_xlim(0,1)
#plt.savefig('/Users/tatha_k/Library/CloudStorage/Box-Box/Research/Optimal_Path/Codes/Optimal-Paths/Plots/histogram4.pdf',bbox_inches='tight')
