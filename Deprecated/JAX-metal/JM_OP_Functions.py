...
def CompMultR(Ar, Ai, Br, Bi):
    return jnp.matmul(Ar, Br)-jnp.matmul(Ai, Bi)
def CompMultI(Ar, Ai, Br, Bi):
    return jnp.matmul(Ar, Bi)+jnp.matmul(Ai, Br)
...
def Del_G_k_updates(G10, G01, k10, k01, G20, G11, G02, k20, k11, k02, csth, snth, r, dt, tau, l1):
    G101 = dt*(G01-snth*(csth*k10+snth*k01)/(4*tau))
    G011 = dt*(-(1+2*l1)*G10+csth*(csth*k10+snth*k01)/(4*tau))
    k101 = dt*k01
    k011 = -dt*(1+2*l1)*k10
    G201 = +dt*(2*G11+snth*(r*k10-csth*k20-snth*k11)/(2*tau))
    G111 = +dt*(G02-(1+2*l1)*G20+(r*(snth*k01-csth*k10)+(csth**2*k20-snth**2*k02))/(4*tau))
    G021 = +dt*(-2*(1+2*l1)*G11+csth*(snth*k02+csth*k11-r*k01)/(2*tau))
    k201 = +dt*(2*k11+2*snth*(csth*G20+snth*G11-r*G10)/tau)
    k111 = +dt*(-(1+2*l1)*k20+k02+(r*(csth*G10-snth*G01)-csth**2*G20+snth**2*G02)/tau)
    k021 = +dt*(-2*(1+2*l1)*k11+2*csth*(-snth*G02-csth*G11+r*G01)/tau)  
    return G101, G011, k101, k011, G201, G111, G021, k201, k111, k021
...
def integrator_step(Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i,  rhor, rhoi, l1max, G10, G01, k10, k01, G20, G11, G02, k20, k11, k02, tau, dt, Id): #Optimal control integration with \lambda_1=0
  ...
  G101, G011, k101, k011, G201, G111, G021, k201, k111, k021 = Del_G_k_updates(G10, G01, k10, k01, G20, G11, G02, k20, k11, k02, csth, snth, r, dt, tau, l1)
  '''
  G101 = G10+dt*(G01-snth*(csth*k10+snth*k01)/(4*tau))
  ...
  return rho2r-rhor, rho2i-rhoi, G101, G011, k101, k011, G201, G111, G021, k201, k111, k021

def RK4_step(i, Input_Initials): #Optimal control integration with \lambda_1=0
  Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i,  rhor, rhoi, l1max, G10, G01, k10, k01, G20, G11, G02, k20, k11, k02, Idth, ts, tau, dt, j, Id = Input_Initials
  rhok1r, rhok1i, G10k1, G01k1, k10k1, k01k1, G20k1, G11k1, G02k1, k20k1, k11k1, k02k1 = integrator_step(Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i, rhor, rhoi, l1max, G10, G01, k10, k01, G20, G11, G02, k20, k11, k02, tau, dt, Id)
  #rhok1r = rhor+(rho1r-rhor)/2.0
  #rhok1i = rhoi+(rho1i-rhoi)/2.0
  rhok2r, rhok2i, G10k2, G01k2, k10k2, k01k2, G20k2, G11k2, G02k2, k20k2, k11k2, k02k2 = integrator_step(Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i, rhor+rhok1r/2.0, rhoi+rhok1i/2.0, l1max, G10+G10k1/2.0, G01+G01k1/2.0, k10+k10k1/2.0, k01+k01k1/2.0, G20+G20k1/2.0, G11+G11k1/2.0, G02+G02k1/2.0, k20+k20k1/2.0, k11+k11k1/2.0, k02+k02k1/2.0, tau, dt, Id)
  rhok3r, rhok3i, G10k3, G01k3, k10k3, k01k3, G20k3, G11k3, G02k3, k20k3, k11k3, k02k3 = integrator_step(Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i, rhor+rhok2r/2.0, rhoi+rhok2i/2.0, l1max, G10+G10k2/2.0, G01+G01k2/2.0, k10+k10k2/2.0, k01+k01k2/2.0, G20+G20k2/2.0, G11+G11k2/2.0, G02+G02k2/2.0, k20+k20k2/2.0, k11+k11k2/2.0, k02+k02k2/2.0, tau, dt, Id)
  rhok4r, rhok4i, G10k4, G01k4, k10k4, k01k4, G20k4, G11k4, G02k4, k20k4, k11k4, k02k4 = integrator_step(Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i, rhor+rhok3r, rhoi+rhok3i, l1max, G10+G10k3, G01+G01k3, k10+k10k3, k01+k01k3, G20+G20k3, G11+G11k3, G02+G02k3, k20+k20k3, k11+k11k3, k02+k02k3, tau, dt, Id)
  rho1r = rhor+rhok1r/6.0+rhok2r/3.0+rhok3r/3.0+rhok4r/6.0
  rho1i = rhoi+rhok1i/6.0+rhok2i/3.0+rhok3i/3.0+rhok4i/6.0
  G101 = G10+G10k1/6.0+G10k2/3.0+G10k3/3.0+G10k4/6.0
  G011 = G01+G01k1/6.0+G01k2/3.0+G01k3/3.0+G01k4/6.0
  k101 = k10+k10k1/6.0+k10k2/3.0+k10k3/3.0+k10k4/6.0
  k011 = k01+k01k1/6.0+k01k2/3.0+k01k3/3.0+k01k4/6.0
  G201 = G20+G20k1/6.0+G20k2/3.0+G20k3/3.0+G20k4/6.0
  G111 = G11+G11k1/6.0+G11k2/3.0+G11k3/3.0+G11k4/6.0
  G021 = G02+G02k1/6.0+G02k2/3.0+G02k3/3.0+G02k4/6.0
  k201 = k20+k20k1/6.0+k20k2/3.0+k20k3/3.0+k20k4/6.0
  k111 = k11+k11k1/6.0+k11k2/3.0+k11k3/3.0+k11k4/6.0
  k021 = k02+k02k1/6.0+k02k2/3.0+k02k3/3.0+k02k4/6.0
  
  Idth1 = Idth
  return (Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i, rho1r, rho1i, l1max, G101, G011, k101, k011, G201, G111, G021, k201, k111, k021, Idth1, ts, tau, dt, j+1, Id)
...
def OPsoln_control_l10_JAX(Initials, Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i,  rho_ir, rho_ii, l1max, ts, dt,  tau, Idmat,  Id):
  #I_tR = jnp.array([0.0])
  ...
  k1=0
  Idth = 0.0
  Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i,  rhor, rhoi, l1max, G10, G01, k10, k01, G20, G11, G02, k20, k11, k02, Idth, ts, tau, dt, k1, Id = jax.lax.fori_loop(0, len(ts)-1, RK4_step,(Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i,  rho_ir, rho_ii, l1max, G10, G01, k10, k01, G20, G11, G02, k20, k11, k02, Idth,  ts, tau, dt, k1, Id))
  #rho_update(Initials, X, P, H, X2, P2, XP, PX, rho, I_tR, I_tI, i, theta_t, ts, tau, dt)
...
@jit
def CostF_control_l101(Initials, Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i,  rho_ir, rho_ii, rho_fr, rho_fi, l1max, ts, dt, tau, Idmat, Id):
  rho_f_simulr, rho_f_simuli = OPsoln_control_l10_JAX(Initials, Xr, Xi, Pr, Pi, Hr, Hi, X2r, X2i, CXPr, CXPi, P2r, P2i,  rho_ir, rho_ii, l1max, ts, dt, tau, Idmat, Id)
...
def OPintegrate_strat(Initials, X, P, H, X2, CXP, P2, rho_i, l1max, ts, dt,  tau, Idmat, Id):
  #I_tR = jnp.array([0.0])
