...
fname  = script_dir+'/Optimal_control_Extmp1.hdf5'
...
cost_b, rho_f_simulr, rho_f_simuli = CostF_control_generate(Initials, Ops, jnp_rho_ir, jnp_rho_ii, jnp_rho_fr, jnp_rho_fi, jnp_theta_mat, jnp_l1_mat, params, Nc, jnp_MMat)
...
while temp>tempf and (n<nsteps):
  ...
  cost_n, rho_nr, rho_ni = CostF_control_generate(Initials_n, Ops, jnp_rho_ir, jnp_rho_ii, jnp_rho_fr, jnp_rho_fi, jnp_theta_mat, jnp_l1_mat, params, Nc, jnp_MMat)
  if (cost_n<cost_b):
